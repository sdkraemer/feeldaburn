...
export class DynamicWorkoutContainerComponent implements OnInit {
    ...
    ngAfterContentInit() {
        ...
        if(!component) {
            console.error("Undefined workout component type. Map it in DynamicWorkoutContainerComponent");
        }
        let componentFactory = this.componentFactoryResolver.resolveComponentFactory(component);
        this.componentRef = this.dynamicWorkoutComponentContainer.createComponent(componentFactory);
