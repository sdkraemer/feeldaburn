...
import { Workout, IWorkout, RunningWorkout, StrengthTrainingWorkout, IRunningWorkout, IStrengthTrainingWorkout } from '../core';
...
export class WorkoutService {
    ...
    getWorkout(_id: string){
        ...
        return this.http
            ...
            .pipe(
                catchError(this.handleError('getWorkout', []))
            );
